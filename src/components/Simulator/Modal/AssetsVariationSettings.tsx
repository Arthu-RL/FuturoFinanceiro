...
function InputSettings({
  ...
  return (
    <div>
      <Label>{desc}</Label>
      <Input
        value={variationType['low-risk']}
        onChange={(e) => callback?.(Number(e.target.value), 'low-risk', variationTypeKey)}
      />
      <Input
        value={variationType['medium-risk']}
        onChange={(e) => callback?.(Number(e.target.value), 'medium-risk', variationTypeKey)}
      />
      <Input
        value={variationType['high-risk']}
        onChange={(e) => callback?.(Number(e.target.value), 'high-risk', variationTypeKey)}
      />
    </div>
  );
}
