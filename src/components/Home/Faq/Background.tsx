...
export const Background = ({ children }: BackgroundProps) => {
  ...
  return windowSize >= 640 && theme === 'dark' ? (
    <Vortex
    ...
    <Fragment>
      ...
      <div className='grid w-full grid-cols-1 items-center gap-16 py-20 pl-56 pr-40 max-2xl:pl-36 max-2xl:pr-20 max-xl:gap-20 max-xl:pl-[6.5rem] max-xl:pr-10 max-xl:pt-10 max-sm:gap-8 max-sm:px-4 max-sm:pb-16'>
        {children}
      </div>
    </Fragment>
  );
