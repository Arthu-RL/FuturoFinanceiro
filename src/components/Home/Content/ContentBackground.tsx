export function ContentBackground() {
  return (
    <div className='absolute left-0 right-0 top-0 flex h-full w-full items-center justify-center bg-white bg-dashed-grid-black/[0.125] dark:bg-black dark:bg-dashed-grid-white/[0.125]'>
