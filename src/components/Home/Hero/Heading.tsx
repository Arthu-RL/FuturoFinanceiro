...
export const Heading = () => {
  ...
  return (
    <div className='z-10 mt-12 flex flex-col gap-6 max-2xl:mt-36 max-xl:mt-3 max-xl:gap-2'>
      <span className='font-manrope text-6xl font-bold max-2xl:text-5xl max-xl:text-3xl xl:-mb-4'>
        Futuro Financeiro
      </span>
      <div className='flex flex-col gap-2'>
        <div className='w-full font-manrope text-4xl font-medium leading-9 max-2xl:text-3xl max-xl:text-xl max-xl:leading-6'>
          <span className='text-foreground'>Aprenda de maneira</span>
          <FlipWords words={words} />
          <br />
          <p className='max-w-[28rem]'>e conquiste suas metas financeiras</p>
        </div>
