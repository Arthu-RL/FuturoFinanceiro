...
function DialogContainer({ children, modalParam }: DialogContainerProps) {
  const { isOpen, uniqueId, setIsOpen } = useDialog();
  ...
  useEffect(() => {
    ...
    setIsOpen(modal === modalParam);
  }, [setIsOpen, modalParam, searchParams]);
