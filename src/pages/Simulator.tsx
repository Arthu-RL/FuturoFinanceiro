...
export default function Simulator() {
  return (
    <section className='h-screen pb-14 pl-28 pr-14 pt-6 max-2xl:h-full max-2xl:pb-12 max-2xl:pl-24 max-2xl:pr-8 max-2xl:pt-8 max-sm:px-4 max-sm:pb-8 max-sm:pt-20'>
      <div
        id='simulator'
        className='grid h-full w-full grid-rows-[1fr_2fr] gap-4 max-2xl:grid-rows-[auto_auto]'
      >
        <Summary />
