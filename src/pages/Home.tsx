...
export default function Home() {
  return (
    <Fragment>
      ...
      <section
        id='#content'
        className='relative grid w-full gap-40 overflow-hidden pb-20 pl-56 pr-40 pt-36 max-2xl:pl-36 max-2xl:pr-20 max-2xl:pt-24 max-xl:gap-24 max-xl:pb-8 max-xl:pl-[6.5rem] max-xl:pr-10 max-sm:gap-10 max-sm:px-4 max-sm:pt-16'
      >
